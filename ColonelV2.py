...
def sendsecurity(who):
    #Send Date
    textnow = datetime.now().strftime('%d-%m-%Y')
    stringsend = "Colonel Technology V2 (Colonel-Tech) Report Date: " + textnow
    ...
    #os.remove('tmp')
    stringsend = "Colonel Technology V2 (Colonel-Tech) Reported"
    sendmsg(stringsend,who)
    sendmsg("=============",who)
...
schedule.every().day.at("09:14").do(sendsecurity,colonel)
schedule.every().day.at("19:14").do(sendsecurity,colonel)
print ('Start Running')
